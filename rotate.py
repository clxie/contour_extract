...
def clipim(path, outdir):
    ...
    #clip rotated imgs
    clipdirimgs(tmpdir, outdir)

    shutil.rmtree(tmpdir)

path = '/mnt/pc-hf198/chunleixie/ml/mnist/all/train/imgsdefect/'
outd = '/mnt/pc-hf198/chunleixie/ml/mnist/all/train/imgsd/'

path2 = '/mnt/pc-hf198/chunleixie/ml/mnist/all/train/labeldefect/'
outd2 = '/mnt/pc-hf198/chunleixie/ml/mnist/all/train/labeld/'
